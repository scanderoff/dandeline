...
export default class CartUpdateForm {
    ...
    onChange() {
        ...
        url.searchParams.append("product_id", fd.get("product_id"));
        url.searchParams.append("size_id", fd.get("size_id"));
        url.searchParams.append("color_id", fd.get("color_id"));
        ...
        fetch(url)
            ...
            .then(result => {
                ...
                if (result["status"] == "Not found") {
                    ...
                    this.$form["do"].textContent = "Нет в наличии";
                ...
                this.$form["do"].textContent = "В корзину";
